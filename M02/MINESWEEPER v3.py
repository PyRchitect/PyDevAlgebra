...
class Menus():
	...
	class ConfigMenu():
		...
		def ConfigDisplay():
			...
			opt = []
			opt.append('[0] - izlaz')
			opt.append('[1] - horizontal separate')
			opt.append('[2] - horizontal spacing')
...
def play(ms:'Game'):
	...
	def show_board():
		...
		if ms.graphics.input_mode == "keyboard":
			...
			lines.append("> UPUTA: polja se otkrivaju/označavaju klikovima miša")
			lines.append("> UPUTA: tip poteza: LC = iskopaj, RC = (od)markiraj")
