...
#  Mar 24, 2024 01:48:26 AM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    ttk::label "$site_3_0.tLa64" \
        -font "-family {Segoe UI} -size 9" -relief flat -anchor w \
        -justify left -text "Službeno mjerenje:" -compound left \
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    ...
    place $site_3_0.tLa67 \
        -in $site_3_0 -x 15 -y 45 -width 39 -relwidth 0 -height 39 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tLa68 \
        -in $site_3_0 -x 62 -y 45 -width 39 -relwidth 0 -height 39 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tLa69 \
        -in $site_3_0 -x 109 -y 45 -width 39 -height 39 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tLa70 \
        -in $site_3_0 -x 156 -y 45 -width 39 -height 39 -anchor nw \
        -bordermode ignore 
    ...
    place $top.tLa49 \
        ...
        -anchor nw -bordermode ignore 
    place $top.tBu47 \
        -in $top -x 345 -y 725 -width 70 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tBu49 \
        -in $top -x 260 -y 725 -width 70 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tLa47 \
