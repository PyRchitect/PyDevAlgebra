...
#  Mar 24, 2024 01:40:44 AM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    ttk::label "$site_3_0.tLa64" \
        ...
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa64" "lbl_temp_kuca_grad" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa66" \
        -font "-family {Segoe UI} -size 18" -relief flat -anchor w \
        -justify left -text "+ 00" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa66" "lbl_temp_kuca_unutra_v_1" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.tLa67" "TLabel1" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.tLa67 \
        -in $site_3_0 -x 15 -y 45 -width 40 -relwidth 0 -height 40 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
