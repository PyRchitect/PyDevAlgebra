...
#  Mar 24, 2024 01:14:00 AM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    ttk::label "$site_3_0.tLa75" \
        -font "-family {Segoe UI} -size 9" -relief flat -anchor w \
        -justify left -text "0000 kPa" -compound left \
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    ...
    place $site_3_0.tLa73 \
        -in $site_3_0 -x 220 -y 20 -width 90 -relwidth 0 -height 22 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tLa75 \
        -in $site_3_0 -x 0 -relx 0.458 -y 150 -width 0 -relwidth 0.125 \
        -height 0 -relheight 0.11 -anchor nw -bordermode ignore 
    place $site_3_0.tLa74 \
        -in $site_3_0 -x 220 -y 120 -width 80 -relwidth 0 -height 22 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tLa72 \
        -in $site_3_0 -x 0 -relx 0.458 -y 50 -width 0 -relwidth 0.125 \
        -height 0 -relheight 0.11 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.tBu49 \
        ...
        -bordermode ignore 
    place $top.tLa49 \
        -in $top -x 15 -y 430 -width 480 -relwidth 0 -height 200 -relheight 0 \
        -anchor nw -bordermode ignore 
