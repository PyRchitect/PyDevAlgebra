...
#  Mar 24, 2024 01:24:43 AM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl:DefineAlias "$site_3_0.tLa52" "lbl_tlak_kuca_unutra_1" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa54" \
        -font "-family {Segoe UI} -size 9" -relief flat -anchor w \
        -justify left -text "Izvan kuće" -compound left \
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa54" "lbl_tlak_kuca_vani_1" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.tLa53" "lbl_tlak_kuca_unutra_v_1" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa55" \
        -font "-family {Segoe UI} -size 18" -relief flat -anchor w \
        -justify left -text "00" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa55" "lbl_tlak_izvan_kuce_v_1" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.tLa52 \
        -in $site_3_0 -x 250 -y 20 -width 100 -height 22 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tLa54 \
        -in $site_3_0 -x 250 -y 100 -width 100 -height 22 -anchor nw \
        -bordermode ignore 
    place $site_3_0.scr51 \
        -in $site_3_0 -x 15 -y 25 -width 180 -height 155 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $site_3_0.tLa53 \
        -in $site_3_0 -x 250 -y 40 -width 100 -height 40 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tLa55 \
        -in $site_3_0 -x 250 -y 120 -width 100 -height 40 -anchor nw \
        -bordermode ignore 
    ...
    place $top.tBu47 \
        ...
        -bordermode ignore 
    place $top.tBu49 \
        -in $top -x 240 -y 645 -width 70 -height 30 -anchor nw \
        -bordermode ignore 
