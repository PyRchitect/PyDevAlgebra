...
#  Mar 24, 2024 01:59:56 AM CET  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 430x770+785+102
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::label "$site_3_0.tLa75" \
        ...
        -justify left -text "0000" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa75" "lbl_tlak_kuca_vani_v" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd "$site_3_0.scr51" \
        -background SystemButtonFace -height 75 \
        -highlightcolor SystemWindowText -width 125 
    vTcl:DefineAlias "$site_3_0.scr51" "box_vlaga" vTcl:WidgetProc "Toplevel1" 1
    ...
    ttk::label "$site_3_0.tLa55" \
        ...
        -justify left -text "00" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa55" "lbl_vlaga_kuca_vani_v" vTcl:WidgetProc "Toplevel1" 1
    ...
    ttk::button "$top.tBu72" \
        ...
        -style btn_unos.TButton 
    vTcl:DefineAlias "$top.tBu72" "btn_pokreni" vTcl:WidgetProc "Toplevel1" 1
    ttk::button "$top.tBu73" \
        -text "Zaustavi" -compound left -style "btn_unos.TButton" \
        -style btn_unos.TButton 
    vTcl:DefineAlias "$top.tBu73" "btn_zaustavi" vTcl:WidgetProc "Toplevel1" 1
    ...
    ttk::label "$site_3_0.tLa66" \
        ...
        -justify left -text "+ 00" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa66" "lbl_temp_grad_v" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa71" \
        -font "-family {Segoe UI} -size 9" -relief flat -anchor w \
        -justify left -text "Osjećaj ugode:" -compound left \
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa71" "lbl_temp_kuca_ugoda" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa62" \
        -font "-family {Segoe UI} -size 18" -relief flat -anchor w \
        -justify left -text "+ 00" -compound left -style "lbl_unos.TLabel" \
        -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa62" "lbl_temp_kuca_vani_v" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa64" \
        -font "-family {Segoe UI} -size 9" -relief flat -anchor w \
        -justify left -text "Ref. postaja:" -compound left \
        -style "lbl_unos.TLabel" -style lbl_unos.TLabel 
    vTcl:DefineAlias "$site_3_0.tLa64" "lbl_temp_grad" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.tLa67" "lbl_temp_ugoda_1" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa68" \
        -font "-family {Segoe UI} -size 9" -borderwidth 1 -relief solid \
        -anchor center -justify left -text "X" -compound left 
    vTcl:DefineAlias "$site_3_0.tLa68" "lbl_temp_ugoda_2" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa69" \
        -font "-family {Segoe UI} -size 9" -borderwidth 1 -relief solid \
        -anchor center -justify left -text "X" -compound left 
    vTcl:DefineAlias "$site_3_0.tLa69" "lbl_temp_ugoda_3" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_3_0.tLa70" \
        -font "-family {Segoe UI} -size 9" -borderwidth 1 -relief solid \
        -anchor center -justify left -text "X" -compound left 
    vTcl:DefineAlias "$site_3_0.tLa70" "lbl_temp_ugoda_4" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.scr57 \
        -in $site_3_0 -x 15 -y 105 -width 180 -height 155 -anchor nw \
        -bordermode ignore 
    ...
    ###################
    place $top.tLa49 \
        -in $top -x 15 -y 510 -width 400 -relwidth 0 -height 200 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tLa48 \
        -in $top -x 15 -y 300 -width 400 -relwidth 0 -height 200 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tBu49 \
        -in $top -x 15 -y 725 -width 75 -relwidth 0 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tBu47 \
        -in $top -x 100 -y 725 -width 75 -relwidth 0 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tBu72 \
        -in $top -x 255 -y 725 -width 75 -relwidth 0 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tBu73 \
        -in $top -x 340 -y 725 -width 75 -relwidth 0 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.tLa47 \
        -in $top -x 15 -y 10 -width 400 -relwidth 0 -height 280 -relheight 0 \
        -anchor nw -bordermode ignore 
